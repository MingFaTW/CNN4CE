...
filedir = os.listdir('D:\\2fre_data')  # type the path of training data
n=0
SNRr=0
...
filedir = os.listdir('D:\\2fre_data')  # type the path of testing data (Testing data should be different from training data. Here use the same data just for ease of demonstration.)
n=0
SNRr=0
SNR_factor=5.9
for filename in filedir:
